...
def plot_with_new_function(w1=0.3, b1=17.0):
    ...
    ax.set_xlim(0, 100)
    ax.set_ylim(-20, 50)
    ax.plot(x_vals, y_new, '-', color='purple', label=f'neuron equation')
...
with col1:
    steigung1 = SyncedSlider("weight", -2.0, 2.0, 1.0, key_prefix="slider_s1", step=0.1)
    y_achsenabschnitt1 = SyncedSlider('bias', -50, 50, -30, key_prefix="slider_y1", step=1)
