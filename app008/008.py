...
with col1:
    steigung1 = SyncedSlider("Gewicht", -2.0, 2.0, round(random.uniform(-2.0, 2.0),1), key_prefix="slider_s1", step=0.1)
    y_achsenabschnitt1 = SyncedSlider('Bias', -50, 50, random.randint(-50, 50), key_prefix="slider_y1", step=1)
