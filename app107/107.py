...
with col1:
    steigung1 = SyncedSlider("slope 1", -2.0, 2.0, round(random.uniform(-2.0, 2.0),1), key_prefix="slider_s1", step=0.1)
    y_achsenabschnitt1 = SyncedSlider('y-intercept 1', -50, 50, random.randint(-50, 50), key_prefix="slider_y1", step=1)
    #st.divider()
    steigung2 = SyncedSlider("slope 2", -2.0, 2.0, round(random.uniform(-2.0, 2.0),1), key_prefix="slider_s2", step=0.1)
    y_achsenabschnitt2 = SyncedSlider('y-intercept 2', -50, 50, random.randint(-50, 50), key_prefix="slider_y2", step=1)
